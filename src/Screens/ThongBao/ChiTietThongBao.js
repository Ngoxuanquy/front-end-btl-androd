...
function ChiTietThongBao({ route, navigation }) {
    ...
    useEffect(() => {
        fetch('http://192.168.0.112:4000' + '/api/users/' + nguoimuon)
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch('http://192.168.0.112:4000' + '/api/lichsumuonhang/id/' + id)
            .then(res => res.json())
            .then(res => res.map(re => {
    ...
    //                         fetch('http://192.168.0.112:4000' + '/api/inventory/update/' + id_users + '/' + product.id, {
    //                             method: 'POST',
    ...
    //                                                 console.log('aaa')
    //                                                 fetch('http://192.168.0.112:4000' + '/api/inventory/update/' + ids + '/' + product.id, {
    //                                                     method: 'POST',
    //                                                     headers: { 'Content-Type': 'application/json' },
    //                                                     body: JSON.stringify({
    //                                                         soluong: a.exist + sanpham.SoLuong
    ...
    useEffect(() => {
        fetch('http://192.168.0.112:4000' + '/api/MuonHang/id/' + id)
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch('http://192.168.0.112:4000' + '/api/inventory')
            .then(res => res.json())
    ...
    //                 console.log('aaa1')
    //                 fetch('http://192.168.0.112:4000' + '/api/inventory/update/' + id_users + '/' + tonkho.productsId, {
    //                     method: 'POST',
    //                     headers: { 'Content-Type': 'application/json' },
    //                     body: JSON.stringify({
    ...
    //                 fetch('http://192.168.0.112:4000' + '/api/inventory/update/' + ids + '/' + tonkho.productsId, {
    //                     method: 'POST',
    //                     headers: { 'Content-Type': 'application/json' },
    //                     body: JSON.stringify({
    //                         soluong: tonkho.exist + hangmuon.SoLuong
    ...
    const handerSubmit = () => {
        ...
        fetch('http://192.168.0.112:4000' + '/api/lichsumuonhang/update/trangthai/' + id, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
