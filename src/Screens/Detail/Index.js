            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{
                        ...
                        <AntDesign name="message1" size={24} color={theme.color} />
                        <Text style={{
                            textAlign: 'center',
                            fontSize: 12,
                            color: theme.color
                    ...
                    <TouchableOpacity style={{
                        ...
                        onPress={() => handelCart()}
                    >
                        <FontAwesome name="cart-arrow-down" size={24} color={theme.color} />
                        <Text style={{
                            fontSize: 12,
                            color: theme.color
                                ...
                                <View key={api._id}>
                                    ...
                                    <View style={{
                                        ...
                                        <LinearGradient
                                            ...
                                            colors={['#ffffff', '#B4DDED', '#83C0F2', '#7a84f3']}
                                            style={{
                                                width: "100%",
                                                zIndex: 10,
                                                padding: 20,
                                    ...
                                    <Text style={{
                                        ...
                                        Vào thu rồi các đôi đã có áo mặc chưa🤣🤣{'\n'}
