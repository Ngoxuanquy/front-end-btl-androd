...
const Drawer = () => {
    ...
    return (
        ...
        <Drawer.Navigator initialRouteName='home'>
            <Drawer.Screen name='home' component={Home_Admin} options={{
                headerShown: true,
                headerStyle: {
            ...
            <Drawer.Screen name='Tạo sản phẩm' component={Create_Product} options={{
                headerShown: true,
                headerStyle: {
                    backgroundColor: '#262626',
                    height: 110
            ...
            <Drawer.Screen name='Danh sách sản phẩm' component={List_Product} options={{
                headerShown: true,
                headerStyle: {
                    backgroundColor: '#262626',
                    height: 110
            ...
            <Drawer.Screen name='Danh sách đơn hàng' component={List_Order} options={{
                headerShown: true,
                headerStyle: {
                    backgroundColor: '#262626',
                    height: 110
            ...
            <Drawer.Screen name='Đơn hàng hoàn thành' component={Order_done} options={{
                headerShown: true,
                headerStyle: {
                    backgroundColor: '#262626',
                    height: 110
